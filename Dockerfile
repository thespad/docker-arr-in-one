...
LABEL org.opencontainers.image.description="A really dumb proof of concept that bundles the stable branch builds of all of the *arr applications into a single container"
